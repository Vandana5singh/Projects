...
st.image('house_prediction.jpg',width=300)
st.title('Welcome to Singapore Price Prediction App! 😇')
st.markdown("hi! 👋 This app is designed to help you estimate the resale price of houses in Singapore. Whether you're a prospective homebuyer looking for your dream home or a seller interested in understanding the market value of your property, our app provides accurate predictions based on various features and attributes of the houses")

st.text('Please adjust the features using the sliders and click "Predict" to see the estimated price. Lets enjoy the journey!🚀')
